...
| File | Relevance |
|------|-----------|
| `crates/bsv-transaction/src/template/mod.rs` | `UnlockingScriptTemplate` trait — implement for STAS/STAS3 |
...
**Bundle factories:**
```rust
/// Factory for constructing multi-transaction STAS3 token operations.
///
